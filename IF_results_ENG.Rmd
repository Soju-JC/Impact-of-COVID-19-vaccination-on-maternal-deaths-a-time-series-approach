...
knitr::opts_chunk$set(
  echo        = TRUE,
  fig.align   = "center",
  out.width   = "\\linewidth",  # <- garante que o knitr peça para caber na linha
  fig.width   = 7,              # ~ 17.8 cm a 2.54 cm/in; cabe no texto com suas margens
  fig.height  = 5,
  dpi         = 300
)
```
...
```{r, echo=TRUE,message=FALSE,warning =FALSE,error=FALSE,fig.align='center'}
immunizedBR_log <-
...
```{r, echo=TRUE,message=FALSE,warning =FALSE,error=FALSE, fig.width=7, fig.height=6, fig.align='center'}
